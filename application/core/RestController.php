...
abstract class RestController extends CI_Controller {
    ...
    protected $_id = 'rest_test07_';//테스트 계정 기준
    ...
    public function __construct($config = 'rest')
    {
        ...
        //$this->_id = $this->_id.date("Ymd");//테스트 계정 날짜지정하기
    ...
    {
        if(AUTHORIZATION::is_token($this->input->request_headers()) === false):
            //throw new DomainException('인증에 실패했습니다.');
            ...
            return AUTHORIZATION::decode_token($this->input->request_headers());
        endif;
    }
