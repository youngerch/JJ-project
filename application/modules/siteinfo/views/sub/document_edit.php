            ...
            <div class="table-wrapper">
                ...
                <table class="table-write">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form-control-plaintext"><?=$info->code;?></div>
                        </td>
                    </tr>
                    <tr>
                        <th scope="row">제목</th>
                    ...
                    <tr>
                        <th scope="row">내용</th>
                        <td>
                            <textarea name="content" id="content" class="form-control" style="height:20rem;"><?=$info->content;?></textarea>
                        </td>
                    </tr>
                    </tbody>
                </table>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('.btn-save').on('click', function(e) {
            ...
            var _document_update_ok = function () {
                $.ajax({
                    type: 'POST',
                    url: '/siteinfo/document_update_process_ajax',
                    dataType: 'json',
            ...
            var _document_update_cancel = function()
            {
                //PASS
            }
